...
<div class="page active" id="page-cover">
  ...
  <div class="card print-card cover-print-card" style="text-align:center;padding:48px 32px">
    <div style="margin:0 auto 16px;text-align:center"><img class="kp-logo kp-logo-lg" src="data:image/png;base64," alt="Kingdom Painting" style="height:110px;width:auto;display:block;margin:0 auto"></div>
    <div style="font-size:11px;font-weight:500;color:#c4922a;text-transform:uppercase;letter-spacing:.15em;margin-bottom:16px">KINGDOM PAINTING INC.</div>
    <div style="font-family:var(--serif);font-size:36px;color:var(--ink);margin-bottom:24px">Bid Proposal</div>
    <div style="width:48px;height:2px;background:#c4922a;margin:0 auto 32px"></div>
    <div style="font-size:11px;color:var(--ink3);text-transform:uppercase;letter-spacing:.1em;margin-bottom:16px">Prepared For</div>
    <div style="font-family:var(--serif);font-size:22px;color:var(--ink);margin-bottom:6px" id="cover-name">—</div>
    <div style="font-size:13px;color:var(--ink2);line-height:1.9" id="cover-addr"></div>
    <div style="font-size:13px;color:#c4922a;margin-top:4px" id="cover-email"></div>
  </div>
  <div class="card">
...
// ─── CLIENT SYNC ────────────────────────────────
function syncClient(){
  const name=v('ci-name'),a1=v('ci-addr1'),a2=v('ci-addr2'),em=v('ci-email');
...
function LoginScreen(){
  ...
  return (
    <div style={{minHeight:'100vh',background:'var(--fg)',display:'flex',alignItems:'center',justifyContent:'center',padding:20}}>
      <style>{STYLE}</style>
      <div style={{width:'100%',maxWidth:380}}>
        ...
        {/* Card */}
        <div style={{background:'var(--card)',borderRadius:16,padding:'32px 28px',boxShadow:'0 4px 32px rgba(0,0,0,.18)'}}>
          <h2 style={{fontSize:20,fontWeight:700,marginBottom:4,color:'var(--fg)'}}>
            {mode==='login' ? 'Sign in' : 'Create account'}
          </h2>
          <p style={{fontSize:12,color:'var(--muted-fg)',marginBottom:24}}>Kingdom Painting CRM</p>
          ...
          <button onClick={submit} disabled={loading} style={{width:'100%',padding:'11px 0',background:'var(--primary)',color:'#fff',border:'none',borderRadius:8,fontSize:14,fontWeight:600,cursor:'pointer',opacity:loading?0.7:1,transition:'opacity 0.15s'}}>
            {loading ? 'Please wait…' : mode==='login' ? 'Sign In' : 'Create Account'}
          </button>

          <div style={{textAlign:'center',marginTop:18,fontSize:12,color:'var(--muted-fg)'}}>
            {mode==='login' ? "Don't have an account? " : 'Already have an account? '}
            <button onClick={()=>{setMode(mode==='login'?'signup':'login');setError('');setMessage('');}}
              style={{background:'none',border:'none',color:'var(--primary)',fontWeight:600,cursor:'pointer',fontSize:12,padding:0}}>
