...
export function buildDemoSeed(){
  ...
  const deals=[
    {id:'dd1',dealName:'Mitchell Master Bedroom Repaint',contact:'dc1',value:3200,stage:'Lead',labels:['Google','Residential'],progress:0,rooms:[{name:'Master Bedroom',done:false},{name:'Walk-in Closet',done:false}],created_at:'2026-06-10T10:00:00Z'},
    {id:'dd2',dealName:'Chen Hallway & Stairwell',contact:'dc2',value:2450,stage:'Lead',labels:['Site','Residential'],progress:0,rooms:[{name:'Hallway',done:false},{name:'Stairwell',done:false}],created_at:'2026-06-15T10:00:00Z'},
    {id:'dd3',dealName:'Patel Whole Home Interior',contact:'dc3',value:14800,stage:'Proposal',labels:['Referral','Residential'],progress:0,quote_date:'2026-06-12',rooms:[{name:'Living Room',done:false},{name:'Kitchen',done:false},{name:'Master Bedroom',done:false},{name:'Bedroom 2',done:false},{name:'Bedroom 3',done:false},{name:'Bathrooms',done:false}],quote_html:demoQuoteHtml('Priya Patel','Whole Home Interior',14800),contract_html:demoContractHtml('Priya Patel','Whole Home Interior',14800),payment_schedule:demoSchedule(14800).map((b,i)=>i===0?{...b,paid:true}:b),invoicePaid:0,created_at:'2026-05-28T10:00:00Z'},
    {id:'dd4',dealName:'Thompson Basement Finishing',contact:'dc4',value:8900,stage:'Proposal',labels:['Home Depot','Residential'],progress:0,quote_date:'2026-06-08',rooms:[{name:'Rec Room',done:false},{name:'Office',done:false},{name:'Bathroom',done:false}],created_at:'2026-05-20T10:00:00Z'},
    {id:'dd5',dealName:'Rodriguez Kitchen & Living',contact:'dc5',value:6750,stage:'Scheduled',referralName:'dc1',labels:['Referral','Residential'],progress:40,startDate:'2026-06-25',startTime:'08:30',endDate:'2026-06-27',endTime:'17:00',rooms:[{name:'Kitchen',done:true},{name:'Living Room',done:false},{name:'Dining Room',done:false}],quote_html:demoQuoteHtml('Emily Rodriguez','Kitchen & Living Room',6750),contract_html:demoContractHtml('Emily Rodriguez','Kitchen & Living Room',6750),contract_signed_html:demoContractHtml('Emily Rodriguez','Kitchen & Living Room',6750).replace('<!--CLIENT_SIGNATURE_SLOT-->','<span style="display:block;font-size:10px;color:#555;margin-top:36px">Electronically signed by <strong>emily.r@example.com</strong> on June 20, 2026</span>'),contract_signed_at:'2026-06-20T14:30:00Z',payment_schedule:demoSchedule(6750),invoicePaid:2362.50,created_at:'2026-05-15T10:00:00Z'},
    {id:'dd6',dealName:'Davidson Unit 204 Turnover',contact:'dc6',value:4300,stage:'Scheduled',referralName:'dc1',labels:['Referral','Commercial'],progress:0,startDate:'2026-07-02',startTime:'09:00',endDate:'2026-07-03',endTime:'17:00',rooms:[{name:'Bedroom',done:false},{name:'Living Area',done:false},{name:'Bathroom',done:false}],created_at:'2026-06-01T10:00:00Z'},
    {id:'dd7',dealName:'Mitchell Exterior Trim',contact:'dc1',value:5600,stage:'Completed',labels:['Referral','Exterior'],progress:100,invoicePaid:5600,materials:920,wages:2100,rooms:[{name:'Front Trim',done:true},{name:'Garage Door',done:true},{name:'Rear Fascia',done:true}],quote_html:demoQuoteHtml('Sarah Mitchell','Exterior Trim',5600),invoice_html:demoInvoiceHtml('Sarah Mitchell','Exterior Trim',5600),created_at:'2026-05-12T10:00:00Z'},
    {id:'dd8',dealName:'Patel Office Accent Walls',contact:'dc3',value:3950,stage:'Completed',labels:['Repeat','Commercial'],progress:100,invoicePaid:2000,materials:480,wages:1300,rooms:[{name:'Office',done:true},{name:'Reception',done:true}],created_at:'2026-06-03T10:00:00Z'},
    {id:'dd9',dealName:'Chen Garage Repaint',contact:'dc2',value:1800,stage:'Archive',labels:['Site','Lost'],progress:0,rooms:[{name:'Garage',done:false}],created_at:'2026-04-18T10:00:00Z'},
  ];
  const activities=[
